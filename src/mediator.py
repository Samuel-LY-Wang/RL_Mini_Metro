...
class Mediator:
    def __init__(self) -> None:
        ...
        # diagnostics counters updated each increment_time()
        self.last_step_boardings = 0
        self.last_step_deliveries = 0
    ...
    def increment_time(self, dt_ms: int) -> None:
        ...
        if self.is_passenger_spawn_time():
            if (self.passenger_spawning_interval_step > 1):
                self.passenger_spawning_interval_step -= passenger_spawn_increase_rate
            ...
            if metro.current_station:
                ...
                for passenger in passengers_from_station_to_metro:
                    if metro.has_room():
                        ...
                        # count boarding event
                        self.last_step_boardings += 1
